...
public class Reflector {
    ...
    public static Reflector on(@NonNull String name
            , boolean initialize) throws ReflectedException {
        return on(name, initialize, Reflector.class.getClassLoader());
    }

    public static Reflector on(@NonNull String name
            , boolean initialize, @Nullable ClassLoader loader) throws ReflectedException {
        try {
    ...
    public Reflector constructor(@Nullable Class<?>... pTypes) throws ReflectedException {
        try {
            mConstructor = mType.getDeclaredConstructor(pTypes);
    ...
    protected void check(@Nullable Object caller, @Nullable Member member
            , @NonNull String name) throws ReflectedException {
        if (member == null) {
    ...
    public Reflector set(@Nullable Object caller
            , @Nullable Object value) throws ReflectedException {
        check(caller, mField, "Field");
        try {
    ...
    public Reflector method(@NonNull String name
            , @Nullable Class<?>... pTypes) throws ReflectedException {
        try {
            mMethod = findMethod(name, pTypes);
    ...
    protected Method findMethod(@NonNull String name
            , @Nullable Class<?>... pTypes) throws NoSuchMethodException {
        try {
            return mType.getMethod(name, pTypes);
        } catch (NoSuchMethodException e) {
            for (Class<?> cls = mType; cls != null; cls = cls.getSuperclass()) {
                try {
                    return cls.getDeclaredMethod(name, pTypes);
    ...
    @SuppressWarnings("unchecked")
    public <R> R callByCaller(@Nullable Object caller
            , @Nullable Object... args) throws ReflectedException {
    ...
    public static class QuietReflector extends Reflector {
        ...
        public static QuietReflector on(@NonNull String name
                , boolean initialize, @Nullable ClassLoader loader) {
            Class<?> clazz = null;
            try {
        ...
        private static QuietReflector on(@Nullable Class<?> type
        ...
        @Override
        public QuietReflector constructor(@Nullable Class<?>... paramTypes) {
            if (skipAlways()) return this;
            try {
                mIgnored = null;
                super.constructor(paramTypes);
            } catch (Throwable e) {
                mIgnored = e;
            }
            return this;
