...
public class HttpsManager {
    ...
    /**
     * @return 允许访问所有的https网站
     */
    public static SSLParams allowAllSSL() {
        SSLParams sslParams = null;
        try {
            sslParams = getSslSocketFactory(null, null, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return sslParams;
    ...
    /**
     * HTTPS 双向认证（单向验证只传certificates）
     *
     * @param certificates 服务器授信证书
     * @param bksFile      本地证书
